        ...
        <div className="relative z-10">
          <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
            <div className="grid md:grid-cols-2 gap-4">
              {stories.map((story) => (
                <div key={story.id} className="bg-white p-4 rounded-xl shadow flex flex-col">
      ...
      <div className="relative z-10">
        <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
          ...
          <div className="bg-white p-4 rounded-xl shadow">
              ...
              <>
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50">
                  <div className="bg-white p-8 rounded-3xl shadow-xl text-center">
                    ...
                    <h2 className="text-3xl font-bold">أحسنت يا بطل!</h2>
                    <p className="mt-3">لقد أكملت أسئلة القصة بنجاح</p>
                  </div>
                </div>
              </>
            )}
            ...
            <p className="text-gray-700 whitespace-pre-line">{scene?.content}</p>
            ...
            {showQuestions && (
              <div className="mt-8 bg-white p-4 rounded-xl shadow">
                ...
                >
                  {answersSubmitted ? t("answersSubmitted") : t("submitAnswers")}
                </button>
              </div>
            )}
          </div>
